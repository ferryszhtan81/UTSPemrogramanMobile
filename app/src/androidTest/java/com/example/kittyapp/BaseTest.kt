...
import com.example.kittyapp.BaseTest.DrawableMatcher.withDrawable
...
open class BaseTest {
    ...
    val lastPosition = DataSource.kitties.size - 1
    ...
    fun checkFirstPosition() {
        hasListItemContent("Ciara", "Age: 3 bulan", "Hobbies: bermain-main",
            R.drawable.ciara)
    }
