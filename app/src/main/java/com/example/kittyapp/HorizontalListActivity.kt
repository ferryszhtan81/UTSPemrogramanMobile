...
import com.example.kittyapp.databinding.ActivityHorizontalListBinding
import com.example.kittyapp.adapter.KittyCardAdapter
...
class HorizontalListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.horizontalRecyclerView.adapter = KittyCardAdapter(
            applicationContext,
            Layout.HORIZONTAL
        )
